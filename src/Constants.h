// Constants.h — Compiler-portable alignment macros, bit-mask helpers, and
//               typed single-bit constants for all widths (U8, U16, U32).
#pragma once

/*******************************************************************************
 * Alignment decorators — portable across MSVC and GCC/Clang
 ******************************************************************************/
